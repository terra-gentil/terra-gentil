...
const cspParts = [
  ...
  "connect-src 'self' https://terra-gentil-game-production.up.railway.app https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://graph.instagram.com",
  "object-src 'none'",
  "base-uri 'self'",
  "form-action 'self'",
